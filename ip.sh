...
awk -v line="hysteria2://$UUID@$HOST_IP:$PORT/?sni=www.bing.com&alpn=h3&insecure=1#$ISP-hysteria2" 'NR==1 {$0=line} 1' "${FILE_PATH}/${SUB_TOKEN}_hy2.log" > tmpfile && mv tmpfile "${FILE_PATH}/${SUB_TOKEN}_hy2.log"
